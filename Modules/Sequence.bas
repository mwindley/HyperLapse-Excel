...
Public Sub SystemCheck()
    ...
    Else
        msg = msg & "x Canon R3 NOT reachable at " & CAMERA_IP() & Chr(10)
    End If
    
    If ArduinoReachable() Then
        msg = msg & "+ Arduino reachable at " & ARDUINO_IP() & Chr(10)
    Else
        msg = msg & "x Arduino NOT reachable at " & ARDUINO_IP() & Chr(10)
    End If
    ...
    Else
        msg = msg & "x Sunset time not set - run InitShoot" & Chr(10)
    End If
