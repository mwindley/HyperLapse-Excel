...
'   -----------------------        --------------------------
'   Gentle left bend ~10°          Left 5° / centre / Left 5° / centre
'                                    (4 rows — should smooth to 1 arc)
'
'   Drive straight for a bit       Right 3° / Left 2° / centre
'                                    (3 rows — should smooth to 1 near-
'                                    straight large-radius arc)
'
'   Clean right turn ~16°          Right 8° / centre
'                                    (2 rows — control case, already clean)
'
'   Drive straight to finish       Right 2° / Left 3° / centre / stop
...
Public Sub SimulateWobblyRecon()
    ...
    ' Intent: gentle left ~10° over ~5 minutes.
    ' Actually: left 5° (2 min), centre (3 min), left 5° (3 min), centre

    ' Row 4: left 5°, drive 2 min
